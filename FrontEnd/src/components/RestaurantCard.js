    ...
    <div className=" w-72 bg-base-100 my-5 transition duration-700 ease-in-out transform hover:-translate-y-1 hover:scale-105  p-4 m-4 ">
      ...
      <div className="flex-col justify-center items-center">
        ...
        <div className="flex justify-between">
          <div
            className={`my-2  w-9 h-5 m-1 text-white justify-center flex ${
              parseInt(avgRating) < 4 ? "bg-orange-500" : "bg-green-600"
            }  `}
          >
            <svg
              aria-hidden="true"
        ...
        {/* Juaggad */}
        {aggregatedDiscountInfo?.shortDescriptionList[0]?.meta != undefined ? (
          <div>
            <p className="text-clip text-gray-300 overflow-hidden font-extralight">
              ___________________________________________
            </p>{" "}
            <p className="text-orange-900  font-normal">
