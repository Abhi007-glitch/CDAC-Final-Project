...
export const Logo = () => {
  return (
    <a href="/">
      <img
        alt="logo"
        className="h-32 w-32 p-4 object-cover bg-pink-50 borde"
...
const Header = () => {
  ...
  return (
    <div className="flex  justify-around item-cborder-b mb-8 mt-2 bg-pink-50 shadow-lg   ">
      <Logo />
      <div className="nav-items  flex flex-row-reverse text-xl font-medium ">
        <ul className="flex justify-center py-10 text-[#484b5c] ">
          <li className=" hover:text-[#ffa701] ">
            <Link to="/">
              <div className="flex">
                ...
                <p className="lg:px-3 md:px-1">Search</p>
              </div>
            </Link>
          </li>
          ...
          <li className="lg:px-8 md:px-4 sm:px:2 hover:text-[#ffa701]">
            <Link to="/offer">
              <div className="flex  ">
                ...
                <p className="lg:px-3 md:px-1">Offer</p>
              </div>
            </Link>
          </li>

          <li className="lg:px-8md:px-4 sm:px:2 hover:text-[#ffa701]">
            ...
            <div className="flex ">
              <li className="font-sans block  lg:inline-block lg:mt-0 lg:ml-6 align-middle text-black hover:text-gray-700">
                <Link href="/cart" role="button" className="relative flex">
                  ...
                  <span className="absolute right-0 top-0 rounded-full bg-red-600 w-4 h-4 top right p-0 m-0 text-white font-sans text-sm  leading-tight text-center">
                    0
                  </span>
                </Link>
              </li>
